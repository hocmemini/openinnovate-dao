...
PROMPT_FILE_V11 = Path(__file__).resolve().parent / "system-prompt-recommend-v1.1.md"
PROMPT_FILE_V10 = Path(__file__).resolve().parent / "system-prompt-recommend-v1.0.md"
PROMPT_FILE = PROMPT_FILE_V11 if PROMPT_FILE_V11.exists() else PROMPT_FILE_V10
